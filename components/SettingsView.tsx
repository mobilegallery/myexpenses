...
const SettingsView: React.FC<SettingsViewProps> = ({ isPinSet, onShowPinModal, onDeletePin, onSync, isSyncing, isSaving, expenses }) => {
    ...
    const handleExportCSV = () => {
        ...
        const headers = ["ID", "Date (BS)", "Date (AD)", "Amount", "Category", "Payer", "Notes"];
